...
#include "husky-sql/table/abstract_table_reader.hpp"
#include "husky-sql/table/orc_table_reader.hpp"
#include "husky-sql/table/text_table_reader.hpp"
...
#ifdef WITH_ORC
        if (table_format == "ORC") {
            return std::make_unique<ORCTableReader>();
        }
#endif
